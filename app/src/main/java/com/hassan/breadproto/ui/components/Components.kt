package com.hassan.breadproto.ui.components
...
import com.hassan.breadproto.ui.theme.Danger
import com.hassan.breadproto.ui.theme.DangerContainer
import com.hassan.breadproto.ui.theme.HassansBreadTheme
import com.hassan.breadproto.ui.theme.OutlineGray
import com.hassan.breadproto.ui.theme.Success
import com.hassan.breadproto.ui.theme.SuccessContainer
import com.hassan.breadproto.ui.theme.Warning
import com.hassan.breadproto.ui.theme.WarningContainer
...
private fun PrimaryButtonPreview() {
    HassansBreadTheme { Column(Modifier.padding(16.dp)) { PrimaryButton(text = "ادفع 3 شيكل", onClick = {}) } }
}

@Preview(showBackground = true)
@Composable
private fun SecondaryButtonPreview() {
    HassansBreadTheme { Column(Modifier.padding(16.dp)) { SecondaryButton(text = "رجوع", onClick = {}) } }
}
...
private fun ScreenHeaderPreview() {
    HassansBreadTheme { Column(Modifier.padding(16.dp)) { ScreenHeader(title = "المخابز المتاحة") } }
}

@Preview(showBackground = true)
@Composable
private fun BigStatDisplayPreview() {
    HassansBreadTheme { Column(Modifier.padding(16.dp)) { BigStatDisplay(label = "المتبقي", value = "45 / 300") } }
}
